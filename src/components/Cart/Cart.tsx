...
import {cartItemsSelector} from "../../redux/Slices/cart/selectors";
...
export const Cart = () => {
    ...
    const totalCount = cartItems.reduce((sum: any, item: any) => sum + item.count, 0);

    const totalPrice = cartItems.reduce((sum: any, item: any) => sum + item.price * item.count, 0);
    ...
    return (
        <div className="content">
            <div className="container container--cart">
                <div className="cart">
                    <div className="cart__top" onClick={onClickClearAll}>
